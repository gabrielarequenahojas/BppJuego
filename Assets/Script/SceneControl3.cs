    ...
    public void startparametros()
    {
        ...
        for (int i = 0; i < anim_gen.Length; i++)
        {
            ...
            while (rep == true)
            {
                ...
                Debug.Log("aqui tamb " + anim_gen.Length);
                if (i == 0)
                {
                    if (anim_gen[0] == anim_gen[1] || anim_gen[0] == anim_gen[2] || anim_gen[0] == anim_gen[3] || anim_gen[0] == anim_gen[4] || anim_gen[0] == anim_gen[5])
                    {
                        rep = true;
                    }
                }
                if (i == 1)
                {
                    if (anim_gen[1] == anim_gen[0] || anim_gen[1] == anim_gen[2] || anim_gen[1] == anim_gen[3] || anim_gen[1] == anim_gen[4] || anim_gen[1] == anim_gen[5])
                    {
                        rep = true;
                    }
                }
                if (i == 2)
                {
                    if (anim_gen[2] == anim_gen[0] || anim_gen[2] == anim_gen[1] || anim_gen[2] == anim_gen[3] || anim_gen[2] == anim_gen[4] || anim_gen[2] == anim_gen[5])
                    {
                        rep = true;
                    }
                }
                if (i == 3)
                {
                    if (anim_gen[3] == anim_gen[0] || anim_gen[3] == anim_gen[1] || anim_gen[3] == anim_gen[2] || anim_gen[3] == anim_gen[4] || anim_gen[3] == anim_gen[5])
                    {
                        rep = true;
                    }
                }
                if (i == 4)
                {
                    if (anim_gen[4] == anim_gen[0] || anim_gen[4] == anim_gen[1] || anim_gen[4] == anim_gen[2] || anim_gen[4] == anim_gen[3] || anim_gen[4] == anim_gen[5])
                    {
                        rep = true;
                    }
                }
                if (i == 5)
                {
                    if (anim_gen[5] == anim_gen[0] || anim_gen[5] == anim_gen[1] || anim_gen[5] == anim_gen[2] || anim_gen[5] == anim_gen[3] || anim_gen[5] == anim_gen[4])
                    {
                        rep = true;
                    }
                }
